...
/**
 * getEnterpriseInfo fetches SAML external identities for an enterprise.
 *
 * @remarks
 * This function uses pagination to fetch all external identities.
 * It will keep fetching until all identities are retrieved.
 *
 * @param toolkit - Octokit instance. See: https://octokit.github.io/rest.js
 * @param enterprise - The slug of the enterprise to fetch identities for.
 * @param cursor - The cursor for pagination, defaults to null.
 * @param carry - The identities already fetched, defaults to null.
 */
